import{c as L,r as d,j as e,G as x,t as c,M as t}from"./index-DWuWYdwO.js";import{C as T,a as D,b as M}from"./ComponentSkeleton-B_nzrx-9.js";import{A as k,S as w}from"./SoundOutlined-WZnCU3Rl.js";import{S as a}from"./Slider-D_21UATg.js";import"./Skeleton-Cqh1Sn3g.js";import"./visuallyHidden-J1ppfhCd.js";function i(s){return`${s}°C`}function R(s){return b.findIndex(n=>n.value===s)+1}const r=10,b=[{value:0,label:"0°C"},{value:20,label:"20°C"},{value:37,label:"37°C"},{value:100,label:"100°C"}];function X(){const s=L(),[n,p]=d.useState(55),v=(S,l)=>{p(l)},[f,C]=d.useState([20,37]),V=(S,l)=>{C(l)},[o,h]=d.useState([20,55]),j=(S,l,m)=>{Array.isArray(l)&&h(m===0?[Math.min(l[0],o[1]-r),o[1]]:[o[0],Math.max(l[1],o[0]+r)])},[y,g]=d.useState([35,76]),A=(S,l,m)=>{if(Array.isArray(l))if(l[1]-l[0]<r)if(m===0){const u=Math.min(l[0],100-r);g([u,u+r])}else{const u=Math.max(l[1],r);g([u-r,u])}else g(l)};return e.jsxs(T,{children:[e.jsx(D,{title:"Slider",caption:"Sliders allow users to make selections from a range of values.",directory:"src/pages/components-overview/slider",link:"https://mui.com/material-ui/react-slider/"}),e.jsx(M,{children:e.jsxs(x,{container:!0,spacing:2.5,children:[e.jsx(x,{item:!0,xs:12,sm:6,children:e.jsxs(c,{spacing:2.5,children:[e.jsx(t,{title:"Basic",codeHighlight:!0,codeString:"<Slider defaultValue={35} />",children:e.jsx(a,{defaultValue:35})}),e.jsx(t,{title:"With Icons",codeString:`<Stack spacing={2} direction="row" sx={{ mb: 1 }} alignItems="center">
...
</Stack>`,children:e.jsxs(c,{spacing:2,direction:"row",sx:{mb:1},alignItems:"center",children:[e.jsx(k,{style:{color:n<=25?"inherit":s.palette.text.secondary}}),e.jsx(a,{"aria-label":"Volume",value:n,onChange:v}),e.jsx(w,{style:{color:n>25?"inherit":s.palette.text.secondary}})]})}),e.jsx(t,{title:"Range",codeString:`<Slider
  getAriaLabel={() => 'Temperature range'}
  value={range}
  onChange={handleRangeChange}
  valueLabelDisplay="auto"
  getAriaValueText={valuetext}
/>`,children:e.jsx(a,{getAriaLabel:()=>"Temperature range",value:f,onChange:V,valueLabelDisplay:"auto",getAriaValueText:i})}),e.jsx(t,{title:"With Label",codeString:`<Slider
  sx={{ mt: 2.5 }}
...
/>`,children:e.jsx(a,{sx:{mt:2.5},"aria-label":"Always visible",defaultValue:80,getAriaValueText:i,step:10,valueLabelDisplay:"on"})}),e.jsx(t,{title:"Vertical",codeString:`<Stack sx={{ height: 300 }} spacing={1} direction="row">
  ...
  <Slider
    ...
    color="warning"
  />
</Stack>`,children:e.jsxs(c,{sx:{height:300},spacing:1,direction:"row",children:[e.jsx(a,{"aria-label":"Temperature",orientation:"vertical",getAriaValueText:i,defaultValue:30}),e.jsx(a,{"aria-label":"Temperature",orientation:"vertical",defaultValue:30,disabled:!0,sx:{"&.MuiSlider-root.Mui-disabled":{"& .MuiSlider-track":{color:"secondary.200"},"& .MuiSlider-thumb":{bgcolor:"primary.light"}}}}),e.jsx(a,{getAriaLabel:()=>"Temperature",orientation:"vertical",getAriaValueText:i,defaultValue:[20,37],marks:b,color:"warning"})]})})]})}),e.jsx(x,{item:!0,xs:12,sm:6,children:e.jsxs(c,{spacing:2.5,children:[e.jsx(t,{title:"Disabled",codeString:"<Slider defaultValue={50} disabled />",children:e.jsx(a,{defaultValue:50,disabled:!0,sx:{"&.MuiSlider-root.Mui-disabled":{"& .MuiSlider-track":{color:"secondary.200"},"& .MuiSlider-thumb":{bgcolor:"primary.light"}}}})}),e.jsxs(t,{title:"Sizes",codeString:`<Slider size="small" defaultValue={70} aria-label="Small" valueLabelDisplay="auto" />
...
/>`,children:e.jsx(a,{"aria-label":"Temperature",defaultValue:60,getAriaValueText:i,valueLabelDisplay:"auto",step:10,marks:!0,min:10,max:110})}),e.jsx(t,{title:"Restricted values",codeString:`<Slider
  ...
  valueLabelDisplay="auto"
  marks={marks}
/>`,children:e.jsx(a,{"aria-label":"Restricted values",defaultValue:20,valueLabelFormat:R,getAriaValueText:i,step:null,valueLabelDisplay:"auto",marks:b})}),e.jsxs(t,{title:"Minimum distance",codeString:`<Slider
