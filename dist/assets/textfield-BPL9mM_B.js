import{r as b,j as e,G as d,t as i,M as l,y as t,ay as r,az as o,x as a,aj as j,b3 as g,bn as w}from"./index-BHUrCk0l.js";import{C as f,a as y,b as I}from"./ComponentSkeleton-Duec2wAU.js";import{E as u}from"./EyeInvisibleOutlined-CCnz2uFT.js";import{E as T}from"./EyeOutlined-ecpR533H.js";import"./Skeleton-D00KhaeD.js";function z(){const[n,c]=b.useState({password:"",showPassword:!1}),p=s=>m=>{c({...n,[s]:m.target.value})},x=()=>{c({...n,showPassword:!n.showPassword})},h=s=>{s.preventDefault()};return e.jsxs(f,{children:[e.jsx(y,{title:"Text Field",caption:"Text fields let users enter and edit text.",directory:"src/pages/components-overview/textfield",link:"https://mui.com/material-ui/react-text-field/"}),e.jsx(I,{children:e.jsxs(d,{container:!0,spacing:3,children:[e.jsx(d,{item:!0,xs:12,lg:6,children:e.jsxs(i,{spacing:3,children:[e.jsx(l,{title:"Basic",codeHighlight:!0,codeString:`<TextField id="outlined-basic" label="Outlined" />
