import{c as b,j as t,B as f,aR as u,a9 as n,P as l,cR as S,dB as c,r as w,G as o,t as j,M as s,x as k,b6 as L,ab as I,d as e,T,aN as W,br as D,cl as F}from"./index-BHUrCk0l.js";import{C as H,a as P,b as N}from"./ComponentSkeleton-Duec2wAU.js";import{F as M}from"./Fab-CUCkHBQl.js";import"./Skeleton-D00KhaeD.js";function g({color:i,theme:r,labelColor:d}){const h=S(r,i),{main:p,contrastText:x}=h;let m=i||"";return["primary","secondary","info","success","warning","error"].includes(m)?{[`& .${c.tooltip}`]:{background:p,color:d||x},[`& .${c.arrow}`]:{color:p}}:{[`& .${c.tooltip}`]:{background:m,color:d||x,boxShadow:r.shadows[1]},[`& .${c.arrow}`]:{color:m}}}const O=u(({className:i,...r})=>t.jsx(n,{...r,classes:{popper:i}}),{shouldForwardProp:i=>i!=="color"&&i!=="labelColor"})(({theme:i,color:r,labelColor:d})=>({...r&&g({color:r,theme:i,labelColor:d})}));function a({children:i,arrow:r=!0,labelColor:d="",...h}){const p=b();return t.jsx(f,{display:"flex",children:t.jsx(O,{arrow:r,...h,theme:p,labelColor:d,children:i})})}g.propTypes={color:l.oneOfType([l.string,l.any]),theme:l.any,labelColor:l.oneOfType([l.string,l.any])};a.propTypes={children:l.any,arrow:l.bool,labelColor:l.oneOfType([l.string,l.any]),rest:l.any};const y=u(({className:i,...r})=>t.jsx(n,{...r,classes:{popper:i}}))(({theme:i})=>({[`& .${c.tooltip}`]:{background:i.palette.common.white,color:"rgba(0, 0, 0, 0.87)",boxShadow:i.shadows[1],fontSize:11}}));y.displayName="LightTooltip";const B=u(({className:i,...r})=>t.jsx(n,{...r,arrow:!0,classes:{popper:i}}))(({theme:i})=>({[`& .${c.arrow}`]:{color:i.palette.secondary.dark},[`& .${c.tooltip}`]:{background:i.palette.secondary.dark}}));B.displayName="BootstrapTooltip";const C=u(({className:i,...r})=>t.jsx(n,{...r,classes:{popper:i}}))(({theme:i})=>({[`& .${c.tooltip}`]:{background:"#f5f5f9",color:"rgba(0, 0, 0, 0.87)",maxWidth:220,fontSize:i.typography.pxToRem(12),border:"1px solid #dadde9"}}));C.displayName="HtmlTooltip";const A=u(({className:i,...r})=>t.jsx(n,{...r,classes:{popper:i}}))({[`& .${c.tooltip}`]:{maxWidth:500}});A.displayName="CustomWidthTooltip";const v=u(({className:i,...r})=>t.jsx(n,{...r,classes:{popper:i}}))({[`& .${c.tooltip}`]:{maxWidth:"none"}});v.displayName="NoMaxWidthTooltip";function _(){const[i,r]=w.useState(!1),d=()=>{r(!1)},h=()=>{r(!0)},p=`
...
>
  <Button>HTML</Button>
</HtmlTooltip>`,children:t.jsxs(o,{container:!0,spacing:1,alignItems:"center",children:[t.jsx(o,{item:!0,children:t.jsx(y,{title:"Add",children:t.jsx(e,{children:"Light"})})}),t.jsx(o,{item:!0,children:t.jsx(B,{title:"Add",children:t.jsx(e,{children:"Bootstrap"})})}),t.jsx(o,{item:!0,children:t.jsx(C,{title:t.jsxs(t.Fragment,{children:[t.jsx(T,{color:"inherit",children:"Tooltip with HTML"}),t.jsx("em",{children:"And here's"})," ",t.jsx(T,{variant:"subtitle1",component:"span",children:"some"})," ",t.jsx("u",{children:"amazing content"}),". it's very engaging. Right?"]}),children:t.jsx(e,{children:"HTML"})})})]})}),t.jsx(s,{title:"Arrow Tooltips",codeString:`<Tooltip title="Add" arrow>
  <Button>Arrow</Button>
