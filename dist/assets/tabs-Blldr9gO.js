import{r as P,j as e,M as N,B as g,ba as A,bb as p,a5 as O,T as o,P as b,a1 as Q,a2 as k,ad as K,G as q,t as $}from"./index-DWuWYdwO.js";import{C as ee,a as ae,b as ie}from"./ComponentSkeleton-B_nzrx-9.js";import"./Skeleton-Cqh1Sn3g.js";function B({children:i,value:l,index:n,...c}){return e.jsx("div",{role:"tabpanel",hidden:l!==n,id:`simple-tabpanel-${n}`,"aria-labelledby":`simple-tab-${n}`,...c,children:l===n&&e.jsx(g,{sx:{pt:2},children:i})})}function E(i){return{id:`simple-tab-${i}`,"aria-controls":`simple-tabpanel-${i}`}}function te(){const[i,l]=P.useState(0),n=(v,u)=>{l(u)};return e.jsx(N,{codeString:`// BasicTabs.tsx
