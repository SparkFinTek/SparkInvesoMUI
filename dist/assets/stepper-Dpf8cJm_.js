import{r as x,j as e,M as w,c$ as $,B as r,d,T as h,P as m,bW as M,bX as V,aR as R,ce as X,bj as y,b_ as I,bi as F,cj as Y,c4 as O,c5 as z,aH as E,aC as J,G as T,t as A}from"./index-DWuWYdwO.js";import{C as K,a as Z,b as ee}from"./ComponentSkeleton-B_nzrx-9.js";import{S as L,a as P,b as D,c as U,d as H}from"./StepLabel-LUqSwVPR.js";import{S as te}from"./index--08G8o3u.js";import{L as ie}from"./LeftOutlined-01qoBXDL.js";import"./Skeleton-Cqh1Sn3g.js";const B=["Select campaign settings","Create an ad group","Create an ad"];function k({children:t,value:i,index:s,...n}){return e.jsx("div",{role:"tabpanel",hidden:i!==s,id:`simple-tabpanel-${s}`,"aria-labelledby":`simple-tab-${s}`,...n,children:i===s&&e.jsx(r,{sx:{p:3},children:t})})}function se(){const[t,i]=x.useState(0),[s,n]=x.useState(new Set),l=a=>a===1,g=a=>s.has(a),u=()=>{let a=s;g(t)&&(a=new Set(a.values()),a.delete(t)),i(p=>p+1),n(a)},c=()=>{i(a=>a-1)},v=()=>{if(!l(t))throw new Error("You can't skip a step that isn't optional.");i(a=>a+1),n(a=>{const p=new Set(a.values());return p.add(t),p})},b=()=>{i(0)};return e.jsx(w,{title:"Basic - Linear",codeString:` // HorizontalLinearStepper.tsx
...
)}`,children:[e.jsx(L,{activeStep:t,orientation:"vertical",children:N.map((u,c)=>e.jsxs(P,{children:[e.jsx(D,{optional:c===2?e.jsx(h,{variant:"caption",children:"Last step"}):null,children:u.label}),e.jsxs(ve,{children:[e.jsx(h,{children:u.description}),e.jsx(r,{sx:{mb:2},children:e.jsxs("div",{children:[e.jsx(d,{variant:"contained",onClick:s,sx:{mt:1,mr:1},color:c===N.length-1?"success":"primary",children:c===N.length-1?"Finish":"Continue"}),e.jsx(d,{disabled:c===0,onClick:n,sx:{mt:1,mr:1},children:"Back"})]})})]})]},u.label))}),t===N.length&&e.jsxs(r,{sx:{pt:2},children:[e.jsx(h,{sx:{color:"success.main"},children:"All steps completed - you're finished"}),e.jsx(d,{size:"small",variant:"contained",color:"error",onClick:l,sx:{mt:2,mr:1},children:"Reset"})]})]})}function _({className:t,style:i,onClick:s}){return e.jsx(r,{className:t,style:{...i,display:"block",top:"87%",right:64},children:e.jsx(d,{onClick:s,endIcon:e.jsx(J,{}),sx:{my:2,mx:1},size:"small",children:"Next"})})}function Q({className:t,style:i,onClick:s}){return e.jsx(r,{className:t,style:{...i,display:"block",top:"87%",left:0},children:e.jsx(d,{onClick:s,startIcon:e.jsx(ie,{}),sx:{my:2,mx:1},size:"small",children:"Back"})})}function ye(){const t=[{label:"San Francisco",imgPath:"https://images.unsplash.com/photo-1537944434965-cf4679d1a598?auto=format&fit=crop&w=400&h=250&q=60"},{label:"Bird",imgPath:"https://images.unsplash.com/photo-1538032746644-0212e812a9e7?auto=format&fit=crop&w=400&h=250&q=60"},{label:"Bali, Indonesia",imgPath:"https://images.unsplash.com/photo-1537996194471-e657df975ab4?auto=format&fit=crop&w=400&h=250&q=80"},{label:"Goč, Serbia",imgPath:"https://images.unsplash.com/photo-1512341689857-198e7e2f3ca8?auto=format&fit=crop&w=400&h=250&q=60"}],i={dots:!0,autoplay:!0,infinite:!0,speed:1e3,slidesToShow:1,slidesToScroll:1,nextArrow:e.jsx(_,{}),prevArrow:e.jsx(Q,{})};return e.jsx(w,{content:!1,sx:{"& .slick-dots":{position:"static",pt:1,pb:1.5},"& .slick-prev:before":{display:"none"},"& .slick-next:before":{display:"none"}},children:e.jsx(te,{...i,children:t.map((s,n)=>e.jsxs(r,{children:[e.jsx(r,{sx:{p:1.75},children:e.jsx(h,{children:s.label})}),e.jsx(r,{component:"img",sx:{height:255,display:"block",overflow:"hidden",width:"100%"},src:s.imgPath,alt:s.label})]},n))})})}_.propTypes={className:m.any,style:m.any,onClick:m.any};Q.propTypes={className:m.any,style:m.any,onClick:m.any};function qe(){return e.jsxs(K,{children:[e.jsx(Z,{title:"Stepper",caption:"Steppers convey progress through numbered steps. It provides a wizard-like workflow.",directory:"src/pages/components-overview/stepper",link:"https://mui.com/material-ui/react-stepper/"}),e.jsx(ee,{children:e.jsxs(T,{container:!0,spacing:3,children:[e.jsx(T,{item:!0,xs:12,lg:8,children:e.jsxs(A,{spacing:3,children:[e.jsx(se,{}),e.jsx(pe,{})]})}),e.jsx(T,{item:!0,xs:12,lg:4,children:e.jsxs(A,{spacing:3,children:[e.jsx(fe,{}),e.jsx(ye,{})]})})]})})]})}export{qe as default};
